...
// IMPORT ACTIONS
var middleware = (0, _redux.applyMiddleware)(_reduxLogger2.default); //Logger must be last middleware in chain, otherwise it will log thunk and promise, not actual actions 
...
// UPDATE a book
store.dispatch((0, _booksActions.updateeBooks)({
    id: 2,
...
function booksReducers() {
        ...
        var action = arguments[1];
        //state={} => this is representing an object, state=[] => array of obejcts
        switch (action.type) {
                case "POST_BOOK":
...
exports.updateeBooks = updateeBooks;
